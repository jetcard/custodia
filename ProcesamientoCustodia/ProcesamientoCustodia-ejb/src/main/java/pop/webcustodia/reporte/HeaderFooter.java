 ...
 */
package pop.webcustodia.reporte;
...
public class HeaderFooter extends PdfPageEventHelper {
    ...
    public void onEndPage(PdfWriter writer, Document document) {
        try {
            ...
            ct.go();
            // logo
            String imagenPath = Paths.get("/pop/webcustodia/resources/jpg", getMaeReporte().getNameLogo()).toString();
            ...
            ct.go();
            // text www 
            Phrase headerText = new Phrase("| www.popular-safi.com  ", FONT);
