...
public class Utilidades {
    ...
    public static Object getEJBRemote(String nameEJB, String iface) throws Exception {
        ...
        try {
            ...
            final String appName = "ProcesamientoCustodia-ear-1.0-SNAPSHOT";
            final String moduleName = "ProcesamientoCustodia-ejb-1.0-SNAPSHOT";
            ...
            System.out.println("EJB fallido: " + e.getMessage());
